class CraftStudio.Model
  constructor: (modelDef, texture) ->
    @rootBoxes = []
    @boxesByName = {}
    boxCount = setupModelBoxesFromDef @, modelDef
    @geometry = createModelGeometry boxCount
    ...
    @material =  new THREE.MeshPhongMaterial
      ...
      transparent: modelDef.transparent == true
  ...
  setupModelBoxesFromDef = (model, modelDef) ->
    boxCount = 0
    ...
    buildBox = (boxDef) ->
      ...
      for childBoxDef in boxDef.children
        box.children.push buildBox childBoxDef

      box

    model.rootBoxes.push( buildBox boxDef ) for boxDef in modelDef.tree
    boxCount

  createModelGeometry = (boxCount) ->
